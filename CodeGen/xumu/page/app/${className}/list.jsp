...
<script type="text/javascript">
	...
	function deleteBtn(id){
		...
		var confirm = function (v, h, f) {
			if (v == 'ok') {
				form.attr("action", '${"$"}{ctx}/业务模块名称/${classNameLower}/delete/'+id).submit();
				return true;
			}else if (v == 'cancel') {
				return true;
			}
...
<div id="content">
	...
	<div class="search">
		<form:form id="searchForm" modelAttribute="${classNameLower}searchCondition" action="${"$"}{ctx}/业务模块名称/${classNameLower}/list.do" method="post">
